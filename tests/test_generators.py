...
@pytest.mark.parametrize("data, filter_currency, expected", [
    ([
         {
            "id": 939719570,
            "state": "EXECUTED",
...
def test_filter_by_currency_exception_test(data, filter_currency, expected):
...
def test_transaction_descriptions_exception_test(data, expected):
