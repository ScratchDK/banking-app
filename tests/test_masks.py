...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Счет 1234567891011121314151617181920212223242526272829303132333435363",
...
def test_get_mask_account(bank_account_number: str, expected: str) -> None:
